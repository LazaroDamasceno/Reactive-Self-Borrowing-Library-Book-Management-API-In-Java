...
public class BorrowsFinderController {
    ...
    @GetMapping("api/v1/borrows/{firstYear}/{lastYear}")
    ...
    @GetMapping("api/v1/borrows/{author}/{firstYear}/{lastYear}")
    @ResponseStatus(value = HttpStatus.OK)
    ...
    @GetMapping("api/v1/borrows/{isbn}/{firstYear}/{lastYear}")
    @ResponseStatus(value = HttpStatus.OK)
    ...
    @GetMapping("api/v1/borrows/{ssn}/{firstYear}/{lastYear}")
    @ResponseStatus(value = HttpStatus.OK)
